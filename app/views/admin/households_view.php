<section class="panel">
    ...
    <div class="panel-header d-flex justify-content-between align-items-center mb-3">
        ...
        <button class="btn gov-btn-primary btn-household-management" data-title="ADD HOUSEHOLD" data-submit-text="Save Household" data-bs-toggle="modal" data-bs-target="#householdModal">
            <i class="fa-solid fa-plus me-2"></i>Add Household
        </button>
    </div>
