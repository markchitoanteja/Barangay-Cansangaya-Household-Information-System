...
$remember_role     = $_COOKIE['remember_role'] ?? 'ADMIN';
$remember_checked   = isset($_COOKIE['remember_token']);
?>
    ...
    <div class="auth-wrapper">
        ...
        <aside class="left-panel">
            ...
            <div class="feature">
                ...
                <div><strong>Household Records</strong><br>Maintain organized household data for residents.</div>
            </div>

            <div class="feature">
                <i class="fa-solid fa-file-lines"></i>
                <div><strong>Digital Documentation</strong><br>Quick access to certificates and official records.</div>
            </div>

            <div class="feature">
                <i class="fa-solid fa-shield-halved"></i>
                <div><strong>Secure System</strong><br>Protected login access for barangay staff and administrators.</div>
            </div>
        </aside>
        ...
        <main class="right-panel">
            ...
            <div class="login">
                ...
                <section class="alert alert-danger alert-section text-center d-none" id="login_alert">
                ...
                <section class="login-card">
                    ...
                    <header class="login-header mb-4 text-center">
                        ...
                        <p class="text-muted small mb-0">
                            Access the Barangay <?= ucfirst($system_information['barangay_name']) ?> Household System
                        </p>
                    </header>
        ...
        <div class="loading-modal">
            ...
            <div class="loading-body">
                <div class="loading-seal">
                    <img src="<?= base_url('public/assets/img/') . $system_information['official_logo'] ?>" alt="Barangay Logo">
                </div>
